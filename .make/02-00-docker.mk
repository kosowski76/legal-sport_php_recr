...
DOCKER_COMPOSE_FILE_MAIN:=$(DOCKER_COMPOSE_DIR)/docker-compose-main.yml
...
DOCKER_COMPOSE_MAIN:=$(DOCKER_COMPOSE_COMMAND) -f $(DOCKER_COMPOSE_FILE_MAIN)
...
docker-build-main: validate-docker-variables ## Build the php base image
	$(DOCKER_COMPOSE_MAIN) build $(DOCKER_SERVICE_NAME_MAIN)

.PHONY: docker-build
docker-build: docker-build-main docker-build-php docker-build-image ## Build the php image and then all other docker images
